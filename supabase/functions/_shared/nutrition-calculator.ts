...
export const EXACT_NAME_NORM_MAP: Record<string, string> = {
  ...
  // 香辛料・スパイス
  "こしょう": "＜調味料類＞香辛料類こしょう黒粉",  // 364kcal/100g（黒こしょう粉）
  "胡椒": "＜調味料類＞香辛料類こしょう黒粉",
  "コショウ": "＜調味料類＞香辛料類こしょう黒粉",
  "黒こしょう": "＜調味料類＞香辛料類こしょう黒粉",
  "黒コショウ": "＜調味料類＞香辛料類こしょう黒粉",
  "白こしょう": "＜調味料類＞香辛料類こしょう白粉",  // 378kcal/100g（白こしょう粉）
  "粗挽きこしょう": "＜調味料類＞香辛料類こしょう黒粉",
