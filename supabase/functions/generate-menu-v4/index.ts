...
// =========================================================
// Types (TargetSlot is re-exported from _shared/save-meal.ts)
// =========================================================

type TargetSlot = SharedTargetSlot;
...
// ensureDailyMealIdsForDates and saveMealToDb are imported from _shared/save-meal.ts
...
async function executeStep3_Complete(
  ...
  while (newCursor < batchEnd) {
    ...
    // 並列バッチを構築（最大 STEP3_CONCURRENCY 個）
